...
public class Test_class_patch {
	...
	public static void orchestractor() throws IOException
	{
		...
		String patch_resource=requrest_repository.patch_resource();
		String patch_request_body=requrest_repository.patch_request_body();
		...
		Utility_common_mehtod_.evidencefilecreator("patch_tc_validation", patch_request_body, response_body);
